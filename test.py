...
it_youtubers = [
    {
        "title": "АйТиБорода",
        "url": "www.youtube.com/c/ITBEARD/",
        "subscribers": 227000,
        "views": 1200024,
    },
    {
        "title": "Диджитализируй!",
        "url": "www.youtube.com/channel/UC9MK8SybZcrHR3CUV4NMy2g/",
        "subscribers": 62700,
        "views": 960245,
    },
    {
        "title": "Senior Software Vlogger",
        "url": "www.youtube.com/user/rojkovdima",
        "subscribers": 90700,
        "views": 2000000,
    },
]

ins_result = collection.insert_many(
    it_youtubers
...
print(
    collection.count_documents({"subscribers": subs})
)  # количество документов в коллекции у которых subs подписчиков
...
collection.update_one(
    {"title": "PyLounge"}, {"$set": {"subscribers": 1000024}}
)
...
collection.update_many(
    {"subscribers": {"$gt": 100000}}, {"$set": {"views": 3000000}}
)
